...
7. M7-B Authority voting, Quote Capsule admission, Completed Orders facts and Generation Restore are locally verified. Official IBKR callback scope, real exchange-session classification, Golden Tape, durable IBKR writes and production restore remain externally BLOCKED.
