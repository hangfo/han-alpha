...
| IBKR Paper validation | DONE E1-A / BLOCKED E1-B | Session self-verification, Artifact Resolver, homogeneous Coverage Corpus and nonzero evaluation are local-test verified; official `ibapi`, real Paper callbacks/Golden Tape/reset/cancel/bracket and every Paper order remain BLOCKED |
| PIT vendor qualification | DONE R1-A / BLOCKED R1-B | Typed evidence artifacts, expiry, independent Ed25519 review, promotion levels and redacted credential presence exist; every initial profile remains BLOCKED pending real rights and sampled payload evidence |
