...
| Explicit aware decision time | PARTIAL | Orchestrator/agents use `DecisionClock`; M1 PIT queries use explicit `AsOfContext`; legacy provider/execution wall clocks remain M2 work |
