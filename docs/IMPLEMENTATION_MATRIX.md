...
| IBKR Paper validation | E1-B PARTIAL REAL / EXTERNAL BLOCKED | TWS Paper 7497, official ibapi 10.48.1, Keychain account discovery and five eligible empty-account API sessions are VERIFIED. Typed Scenario Cases, 22+2 Scope topology, Observer positive allowlist, precise visibility/origin evidence and isolated one-shot bounded Paper fixture are locally verified. No fixture write has occurred; static positions, API/ALL orders, resets/recovery and full Golden Tapes remain BLOCKED |
